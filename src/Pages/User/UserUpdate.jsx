...
function UserUpdate() {
    const { id } = useParams()
    const { allUserData,isSuccess,isError,isLoading,message,updateStatus } = useSelector((state) => state.auth)
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="block">
                                    <div className="title"><strong className="d-block">Update Form</strong></div>
